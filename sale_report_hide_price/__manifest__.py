...

{
    ...
    'summary': '''Hide price/discount in Sale Order Report.
                 This module is to hide price/discount
                 in Sale Order Report.
                 It would give you 2 additional fields
                 on Sales Order / Quotation:
                 1. Show Price
                 2. Show Discount Based on the choices on
                    the fields, the relevant
