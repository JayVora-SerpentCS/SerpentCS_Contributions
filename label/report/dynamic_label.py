...
class report_dynamic_label(report_sxw.rml_parse):           
    def get_data(self, row, columns, ids, model, number_of_copy):
        ...
        result1 = []
        list_newdata = []
        for row in range(len(result)/(columns + 1)):
...
# report_sxw.report_sxw('report.dynamic.label',
# 'label.config','addons/label/report/dynamic_label.mako',
